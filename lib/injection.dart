...
import 'package:movietv/data/datasources/movie_local_data_source.dart';
import 'package:movietv/data/datasources/movie_remote_data_source.dart';
...
import 'package:movietv/domain/usecases/get_now_playing_movies.dart';
import 'package:movietv/domain/usecases/get_popular_movies.dart';
import 'package:movietv/domain/usecases/get_top_rated_movies.dart';
...
import 'package:movietv/domain/usecases/search_movies.dart';
import 'package:movietv/domain/usecases/get_now_playing_tvs.dart';
import 'package:movietv/domain/usecases/get_popular_tvs.dart';
import 'package:movietv/domain/usecases/get_top_rated_tvs.dart';
import 'package:movietv/domain/usecases/get_watchlist_tvs.dart';
import 'package:movietv/domain/usecases/search_tvs.dart';
import 'package:movietv/domain/usecases/get_tv_detail.dart';
import 'package:movietv/domain/usecases/get_tv_recommendations.dart';

import 'package:movietv/presentation/provider/movie_detail_notifier.dart';
import 'package:movietv/presentation/provider/movie_list_notifier.dart';
import 'package:movietv/presentation/provider/movie_search_notifier.dart';
import 'package:movietv/presentation/provider/popular_movies_notifier.dart';
import 'package:movietv/presentation/provider/top_rated_movies_notifier.dart';
import 'package:movietv/presentation/provider/watchlist_movie_notifier.dart';
...
import 'package:movietv/presentation/provider/popular_tvs_notifier.dart';
import 'package:movietv/presentation/provider/top_rated_tvs_notifier.dart';
import 'package:movietv/presentation/provider/watchlist_tv_notifier.dart';
import 'package:movietv/presentation/provider/now_playing_tvs_notifier.dart';
